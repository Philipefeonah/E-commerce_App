            ...
            <div class="form">
                <form id="loginForm" action="customer-login" method="post">
                    ...
                    <div class="links">
                        ...
                        <a href="signup-form.jsp">Signup</a>
                    </div>
                    <div class="inputBox">
...
<script>
    document.getElementById('loginForm').onsubmit = function(event) {
        ...
        // Perform any additional validation or operations here if needed
        window.location.href = "customerDashboard.jsp"; // Redirect to customer dashboard
    };
</script>
</body>
</html>
